		...
		<div className="bg-gradient-to-tr from-purple-600 to-blue-900 min-h-screen">
			...
			<div className="flex flex-col items-center justify-center h-full">
				...
				<p className="text-white text-lg px-10 mb-8 lg:mb-8 lg:px-4">
					In this survey, you will encounter several scenarios, and your
					objective is to carefully select your course of action in each
					situation.
				</p>
				<p className="text-white text-lg px-10 mb-8 lg:mb-8 lg:px-4">
					The questions are timed, and you should be able to complete them in
					under three minutes.
				</p>
				<p className="text-white text-lg px-10 mb-8 lg:mb-8 lg:px-4">
